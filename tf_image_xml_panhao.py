...
if __name__ == '__main__':
    ...
    # j=0
    img_dir_base = "./img_panhao"


    xml_output_base = "./img_panhao_output"
    # may_mkdir(xml_output_dir)

    for dir_name in os.listdir(img_dir_base):
        print("*"*80)
        print(dir_name)
        img_dir = os.path.join(img_dir_base, dir_name)
        ...
        for img_filename in os.listdir(img_dir):
            ...
            folder.appendChild(doc.createTextNode(dir_name))
            ...
            output_path = os.path.join(xml_output_base, dir_name)
            may_mkdir(output_path)
            with open(os.path.join(output_path, img_filename[:-3]+"xml"), 'wb') as f:
